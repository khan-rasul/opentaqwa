...
import { ChevronLeft, Mail, Lock, LogIn, UserPlus } from "lucide-react-native";
                ...
                >
                    ...
                    <Animated.View entering={FadeInDown.duration(800)}>
                        ...
                        <Text className="text-white/50 font-quicksand font-medium text-base mb-10">
                            Continue your spiritual journey with OpenTaqwā
                        </Text>
                    </Animated.View>
                    ...
                    >
                        ...
                        <Pressable className="self-end">
                            <Text className="text-[#af8f69] font-quicksand font-bold text-sm">
                                Forgot Password?
                            </Text>
                        </Pressable>
