    ...
    return (
        <View className="flex-row items-center justify-between mb-3">
            ...
            <View className="flex-1">
                <Text className="text-[20px] font-montserrat font-black text-white tracking-[0.5px]">
                    {title}
                </Text>
                {subtitle && (
                    <Text className="text-[10px] font-quicksand font-bold text-white/40 tracking-[1.2px] uppercase mt-[1px]">
                        {subtitle}
                    </Text>
                )}
            </View>
